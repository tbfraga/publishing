...
\multicolumn{4}{c}{new ABC Multcriteria Classification with AHP} \\
\\
\multicolumn{4}{l}{car mechanics company} \\
\cline {1-4} \\
\multicolumn{4}{c}{75 sales between October 2020 and July 2023} \\
\\
  &  \multicolumn{1}{c}{quant.} & \multicolumn{1}{c}{\%} & \multicolumn{1}{c}{cutoff} \\
A &  10 & 23.81 \% &  80 \% \\
B &  15 & 35.71 \% &  95 \% \\
C &  17 & 40.48 \% & 100 \% \\
\cline {1-4} \\
\multicolumn{4}{l}{furniture trades company} \\
\cline {1-4} \\
\multicolumn{4}{c}{254 sales between } \\
\\
 &  \multicolumn{1}{c}{quant.} & \multicolumn{1}{c}{\%} & \multicolumn{1}{c}{cutoff} \\
...
\cline {1-4} \\
 ...
 \multicolumn{4}{l}{plastic packaging manufacturing company}\\
\cline {1-4} \\
\multicolumn{4}{c}{5,967 sales between November 2019 and February 2023} \\
\\
 &  \multicolumn{1}{c}{quant.} & \multicolumn{1}{c}{\%} & \multicolumn{1}{c}{cutoff} \\
...
\end{tabular}
\caption{ABC multicriteria classifications for three companies (results found by COPSolver)}
\label{tab:results}
\end{center}
\end{table} 
    ...
    \section{RESPONSABILIDADE AUTORAIS}
        ...
        Os autores são os únicos responsávelis pelo conteúdo deste trabalho.
