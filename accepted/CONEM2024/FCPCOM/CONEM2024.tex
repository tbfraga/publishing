...
The question is: is the difference between the importance of a product with a 30-day lead time and a product with a 7-day lead time really only 0.35\%. This importance can only really be appreciated when put in comparison with the difference in importance of 12\% between the product with the highest turnover and the product with the lowest turnover. 

Analyzing these values, we come to the conclusion that it seems coherent to adopt as a measure for the weights not gross values, but comparative values. This conclusion gave rise to the idea of assigning comparative weights.
