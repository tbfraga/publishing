...
$w_{pc}$ is the normalized weight percentage of the product $p$ according to criterion $c$;
    ...
    To test the methodology proposed in this article, data were collected from three companies from three different sectors: car mechanics; furniture trades; and plastic packaging manufacturing. Based on the data collected, three benchmarks were developed. The date.txt files corresponding to these three benchmarks are available at https://tbfraga.github.io/COPSolver/ benchmarks/.
