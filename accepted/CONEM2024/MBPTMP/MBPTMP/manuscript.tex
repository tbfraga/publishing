...
\item important inventory control support for some industries.
\end{highlights}

\begin{keyword}
multi-product batch problem\sep p-batch problem \sep processing time maximization \sep integer programming model \sep analytical solution \sep LINGO
\end{keyword}
\end{frontmatter}
...
%\bibitem[\protect\citeauthoryear{COPSolver}{2023}]{COPSolver2023}
%COPSolver (2023). COPSolver: open source software for solving combinatorial optimization and other decision problems - library for solving the multi-product p-batch processing time maximization problem. {\it codeocean and GitHub}, codeocean.com/capsule/4837209/tree/v1, github.com/tbfraga/COPSolver/releases/tag/v1.0-1.
