...
%%Research highlights
\begin{highlights}
\item generative method for force consistency of pairwise comparisons matrix;
\item importance of the correct balance of weights assigned to the criteria;
\item evidence of the importance of ABC multicriteria clssf for forecasting.
\end{highlights}
