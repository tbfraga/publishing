...
O problema DMPMPpBPTM portanto, consiste em definir o tempo máximo de produção para lotes multi-produtos paralelos, para cada período considerado, tendo como base os seguintes aspectos:
...
\begin{equation}
\label{MBPTMP01}
max \sum_{d} {\{T_d} - \{\sum_{i} \textrm{UD}_{id}/ \sum_{i} \textrm{p}_i\} \}\quad 
\end{equation}
