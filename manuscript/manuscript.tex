...
& $St|Dt|C_{\textrm{max}}, TT|UC, DD$ & algorithm \\
\cline {1-3} \\
\cite{FumeroEtAl2016} & $MS|Pl|MPC|D,P,Sc|Cc|$ & mixed-integer linear  \\
& $St|Dt|NP|UC,SC$ & programming model \\
& & solved with CPLEX \\
\cline {1-3} \\
\cite{LiuEtAl2020} & $MS|DNt|s\textrm{-}batch|Sz|MP$ & mixed-integer quadratic \\
& $|St|Dt|SC,WIPC|UC,WIP$ & programming model  \\
& & and exact algorithm \\
\cline {1-3} \\
\end{tabular}
