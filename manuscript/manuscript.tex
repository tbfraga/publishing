...
\node[draw,dashed,rounded corners,fit=(O1) (O2),inner sep=15pt,label={west:\rotatebox{90}{mode}}](mode){};

\node[below left=3.5cm and 6cm of mode.south, draw, rotate=90](M1){makespan};
\node[right=1cm of M1.south west, draw, rotate=90](M2){setup/holding cost};
\node[right=1cm of M2.south west, draw, rotate=90](M3){customer satisfaction};
\node[right=1cm of M3.south west, draw, rotate=90](M4){plant performance};
\node[draw,dashed,rounded corners,fit=(M1) (M2) (M3) (M4),inner sep=15pt,label={west:\rotatebox{90}{performance measure}}](measure){};

\node[right=2.5cm of M4.south west, draw, rotate=90](R1){family incompatibility};
\node[right=1cm of R1.south west, draw, rotate=90](R2){capacity constrained};
\node[right=1cm of R2.south west, draw, rotate=90](R3){color incompatibility};
\node[right=1cm of R3.south west, draw, rotate=90](R4){work-in-process storage};
\node[draw,dashed,rounded corners,fit=(R1) (R2) (R3) (R4),inner sep=15pt,label={west:\rotatebox{90}{restriction}}](restriction){};

\node[below right =1cm and 0cm of measure.south west](N1){};
\node[right =1cm of N1](N2){};
...
\node[right=4cm of N1](N3){};
\node[right =1cm of N3](N4){};
\draw[red, very thick] (N3.east) -- (N4.west);

\node[right =0cm of N4](A2){\cite{LiuEtAl2020}};
...
\node[below right =-2.5mm and 1mm of O1.south](N5){};
\node[above right =-2.5mm and -1.5mm of M2.east](N6){};

\draw[red, very thick] (N5) -- (N6);
