...
\title{Um novo modelo de avaliação para o curso de Engenharia de Produção}
...
\begin{abstract} 
Este artigo apresenta um modelo de avaliação semestral baseado no processo seletivo de empresas multinacionais a na abordagem metodologica Aprendizado Baseado na Prática. 
\end{abstract}
%%Graphical abstract
