...
\item integer programming model for the MBPTM problem;
\item exact optimization method for solving the MBPTM problem.
\end{highlights}

\begin{keyword}
multi-product p-batch \sep processing time maximization \sep mathematical model \sep exact method \sep LINGO
\end{keyword}
\end{frontmatter}
...
\bibitem[\protect\citeauthoryear{COPSolver}{2023}]{COPSolver2023}
COPSolver (2023). COPSolver: open source software for solving combinatorial optimization and other decision problems - library for solving the multi-product batch processing time maximization problem. {\it codeocean and GitHub}, codeocean.com/capsule/4837209/tree/v1, github.com/tbfraga/COPSolver/releases/tag/v1.0-1.
